...
class CoursesListPage(BasePage):
    ...
    def check_visible_create_course_button(self):
        """
        Метод проверяет видимость кнопки для создания нового курса
        """
        expect(self.create_course_button).to_be_visible()

    def click_create_course_button(self):
        """
        Метод нажимает на кнопку для перехода на страницу создания курса
        """
    ...
    def click_edit_course(self, index: int):
        """
        Метод для нажатия кнопки редактирования курса в меню

        :param index:  Индекс курса для работы с нужной карточкой
        """
    ...
    def click_delete_course(self, index: int):
        """
        Метод для нажатия кнопки удаления курса в меню
