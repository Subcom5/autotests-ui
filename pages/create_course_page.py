...
class CreateCoursePage(BasePage):
    """
    Page Object для страницы создания курса
    """
    ...
    def check_visible_create_course_title(self):
        """
        Метод проверки наличия заголовка Create course
        """
    ...
    def click_create_course_button(self):
        """
        Метод нажатия кнопки создания курса
        """
        self.create_course_button.click()

    def check_visible_create_course_button(self):
        """
        Метод проверки видимости кнопки создания курса
        """
        expect(self.create_course_button).to_be_visible()

    def check_disabled_create_course_button(self):
        """
        Метод проверки неактивности кнопки создания курса
        """
        expect(self.create_course_button).to_be_disabled()

    def check_visible_image_preview_empty_view(self):
        """
        Метод проверяет, что отображается пустой блок для превью изображения
        """
    ...
    def check_visible_image_upload_view(self, is_image_uploaded: bool = False):
        ...
        :param is_image_uploaded:  Если is_image_uploaded = True, проверяет кнопку "Remove image"
        """
    ...
    def click_remove_image_button(self):
        """
        Метод нажатия кнопки "Remove image"
        """
    ...
    def check_visible_create_course_form(
        ...
        """
        Метод проверяет наличие полей формы создания курса и их значения

        :param title: Название курса
        :param estimated_time: Время прохождения
        :param description: Описание курса
        :param max_score: Максимальное количество баллов
        :param min_score:  Минимальное количество баллов
        """
    ...
    def fill_create_course_form(
        ...
        """
        Метод для заполнения формы создания курса
    ...
    def check_visible_exercises_title(self):
        """
        Метод для проверки заголовка Exercises
        """
    ...
    def click_create_exercise_button(self):
        """
        Метод нажатия кнопки создания упражнения
        """
        self.create_exercise_button.click()

    def check_visible_exercises_empty_view(self):
        """
        Метод проверки отображения пустого блока для заданий
        """
    ...
    def check_visible_create_exercise_form(self, index: int, title: str, description: str):
        """
        Метод проверки формы редактирования упражнения по индексу
    ...
    def fill_create_exercise_form(self, index: int, title: str, description: str):
        """
        Метод для заполнения формы для редактирования упражнения
