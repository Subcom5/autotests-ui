...
class CreateCourseFormComponent(BaseComponent):
    """
    Класс описывает взаимодействие с компонентом - форма создания курса
    """
    def __init__(self, page: Page):
        ...
        self.description_textarea = Textarea(
            page, 'create-course-form-description-input', 'Textarea'
        )
    ...
    def fill(
        ...
        """
        Метод заполняет данными форму создания курса
    ...
    def check_visible(
        ...
        """
        Метод проверяет корректность отображения формы создания курса и валидность данных
